...
Name: ecartis
Vendor: Pegasus Computing
Version: 1.0.1
Release: 1
License: GPL
Group: Applications/Mail
Source: ftp://ftp.ecartis.net/pub/ecartis/%{name}-%{version}.tar.gz
URL: http://www.ecartis.net/
Prefix: /home/ecartis
Packager: Ecartis Project <bugs@ecartis.net>
Buildroot: /var/tmp/ecartis-root

%changelog
* Tue Mar 26 2024 Jim Trigg <jtrigg@ecartis.net>
- Updated version to 1.0.1, updated source to ecartis.net, updated vendor to Pegasus Computing
